...
//
const BotName = 'AUF•BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/af_project_01/'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/6285726297302'; // Nomor whatsapplu cok
const kapanbotaktif = 'HANYA KALAU DIAKTIFKAN'; // Kapan bot lu aktif
const grupch1 = 'TIDAK TERSEDIA'; // OFFICIAL GRUP LU 1
const grupch2 = 'TIDAK TERSEDIA'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @aufanino`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @aufanino`)
})
...
if (text.includes("$0040$")){
const teks = text.replace(/$0040$ /, "")
...
if (text.includes("$0020$")){
const teks = text.replace(/$0020$ /, "")
...
if (text.includes("$0030$")){
const teks = text.replace(/$0030$ /, "")
axios.get(`http://scrap.terhambar.com/yt?link=${teks}`).then((res) => {
...
if (text.includes("$0050$")){
const teks = text.replace(/$0050$ /, "")
...
if (text.includes("$0060$")){
const teks = text.replace(/$0060$ /, "")
...
if (text.includes("$0070$")){
const teks = text.replace(/$0070$ /, "")
...
/*   if (text.includes("#yt"))
   ...
   {
    var items = ["ullzang girl", "cewe cantik", "hijab cantik", "korean girl", "cewe imut", "cewe estetik", "cewe manis", "cewe korea", "ukhty cantik", "ukhti cantik"];
   ...
   {
    var items = ["cowo ganteng", "cogan", "korean boy", "chinese boy", "japan boy", "cowo keren", "cowo estetik"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
...
if (text.includes("#randomanime"))
   {
    var items = ["anime girl", "anime cantik", "anime", "anime aesthetic", "loli", "waifu"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
